 ...
 const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    if (isLogin) {
      ...
      // 🔹 REGISTER (backend expects different field names)
      const payload = {
        ...
        ev_make: formData.evMake || null,
        ev_model: formData.evModel || null,
        ev_year: formData.evYear || null,
        battery_capacity: formData.batteryCapacity || null,
        compatible_charger_types: formData.compatibleChargers || [],
      };
